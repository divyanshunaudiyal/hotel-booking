...
<div class="row well">
    <div class="col-sm-12">
        <div class="panel panel-primary">
            <div class="panel-heading center" style="font-size: 18px; font-weight: 700;">Edit Roomtype Details..!</div>
                        ...
                        <div>
                            ...
                            <div class="col-sm-12" style="margin-top: 8px;">
                                ...
                                <div class="col-sm-6">  
                                    ...
                                    <input type="text" id="room_type" value="<?= $model->room_type ?>" name="room_type" class="form-control he">
