            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="widget widget_nav_menu">
                        <h4 class="widget-title">Class & Subjects</h4>
                        <ul>
                            <li><a href="#">10th Grade Math</a></li>
                            <li><a href="#">10th Grade Physics</a></li>
                            <li><a href="#">10th Grade Biology</a></li>
                            <li><a href="#">11th Grade Physics</a></li>
                            <li><a href="#">11th Grade Math</a></li>
                            <li><a href="#">11th Grade Chemistry</a></li>
                            <li><a href="#">12th Grade Physics</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 order-lg-8 text-lg-center align-self-center mt-lg-0 mt-3">
                    <p>copyright 2022 by edumint.com</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- all plugins here -->
<script src="<?= FRONT_STATIC_URL ?>assets/js/vendor.js"></script>
<!-- main js  -->
<script src="<?= FRONT_STATIC_URL ?>assets/js/main.js"></script>