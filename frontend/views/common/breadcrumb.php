...
try {
        ...
        $modeldata = new User();
$userdata = $modeldata->Useradmin($user_id);
...
<!--            <a style="float:none" href="https://www.pmsaifworld.com/terms-and-conditions/" target="_blank"><i class="fa fa-info-circle fa-6"></i> <span class="nav-label">Copyright</span></a>-->
        ...
        <li >
            <a id="Setmore_button_iframe" style="float:none" ><i class="fa fa-user fa-6"></i> <span class="nav-label"><?= ucwords($userdata['username'])?> [<?= ucwords($userdata['user_type'])?>]</span></a>
        </li>
<li>
