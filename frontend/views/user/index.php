...
<div class="row " style="margin-bottom: 4%;">  
    <div class="col-sm-4  ab">
        <span>All Vendor Details</span>
    </div>
    <div class="col-sm-5"></div>
    <div class="col-sm-3"  style="margin-top:4%;" >
        <a class="btn btn-block  btn-primary btn-rounded" href="<?= BASE_URL ?>vendor-create">Add New Vendor</a>
    </div>
</div>
                            ...
                            foreach ($userlist as $val) {
                                ...
                                <tr>
                                   <td>
                                    ...
                                    <td style="text-align: center;">
                                        <?= !empty($val['created_at']) ? date('d-M-Y', strtotime($val['created_at'])) : ''; ?>
                                    </td>
