...
<div class="row " style="margin-bottom: 4%;">  
    ...
    <div class="col-sm-3"  style="margin-top:4%;" >
        <a class="btn btn-block  btn-primary btn-rounded" href="<?= BASE_URL ?>hotels-create">Add Hotel</a>
    </div>
</div>
                        ...
                        if (!empty($data)) {
                            ...
                            foreach ($data as $val) {
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="<?= BASE_URL ?>hotels/update?id= <?= $val['id'] ?>" title='Edit'><button type="button" class="btn btn-success">Edit</button></a>
                                        <a href="<?= BASE_URL ?>hotels/delete?id= <?= $val['id'] ?>" title='Edit'><button type="button" class="btn btn-danger">Delete</button></a>
                                    </td>
                                </tr>
                                <?php
                                $i++;
